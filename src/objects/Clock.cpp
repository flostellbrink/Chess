...
Clock::Clock() {
  ...
  manager->AddObject(rotate_z(new BasicObject(objects::clock_time_cap, glm::vec3(3.4f, 3, 16.8f), 0, "noLight"), 2 * glm::pi<float>() * (black_time_ / 3600000)));
  ...
  manager->AddObject(rotate_x(new BasicObject(objects::clock_glass_border, glm::vec3(-3.4f, 3, 17)), glm::pi<float>() / -2.0f));
  manager->AddObject(rotate_x(new BasicObject(objects::clock_face, glm::vec3(-3.4f, 3, 16.9f), 0, "noLight"), glm::pi<float>() / -2.0f));
  manager->AddObject(rotate_z(new BasicObject(objects::clock_time_cap, glm::vec3(-3.4f, 3, 16.8f), 0, "noLight"), 2 * glm::pi<float>() * (white_time_ / 3600000)));
}
